...
@SpringBootTest(
        ...
        classes = {MulitiPartTest.TestController.class, MulitiPartTest.TestConfiguration.class},
...
public class MulitiPartTest {
    ...
    public void shouldProcessSingleMultipart() {
        ...
        final Map<String, List<ByteBuffer>> returned = client.multipart(parts).block();
    ...
    public void shouldProcessSingleMultipartBody() {
        ...
        final Map<String, List<ByteBuffer>> returned = client.multipartBody(parts).block();
    ...
    @Test
    @Ignore("Currently Spring does not support more than 1 value in Flux<Part> (see org.springframework.http.codec.multipart.MultipartHttpMessageWriter)")
